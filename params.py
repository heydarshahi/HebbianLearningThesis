...
DATA_FOLDER = os.environ.get('IMAGENET_DIR', 'data/datasets-tmp/tiny-imagenet-200')
# print(DATA_FOLDER)
...
CONFIG_FAMILY_KROTOV = 'krotov' # Key to identify configurations based on Krotov learning rule
