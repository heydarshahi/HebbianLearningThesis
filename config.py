...
class Configuration:
    def __init__(self,
        ...
        for iter_id in self.ITERATION_IDS:
            ...
            # Path where to save accuracy plot
            self.ACC_PLT_PATH[iter_id] = P.RESULT_FOLDER + '/' + self.CONFIG_ID + '/figures/accuracy' + str(
                iter_id) + '.png'
            # Path where to save kernel images
            self.KNL_PLT_PATH[iter_id] = P.RESULT_FOLDER + '/' + self.CONFIG_ID + '/figures/kernels' + str(
                iter_id) + '.png'
...
CONFIG_LIST = [
    ...
    Configuration(
        ...
        pre_net_mdl_path=P.PROJECT_ROOT + '/results/hebb/g1_2h3_6/save/model0.pt',
        # Path to non-exising file, because in this case the model is already loaded in the constructor of the pre-net
    ...
    Configuration(
        ...
        pre_net_mdl_path=P.PROJECT_ROOT + '/results/hebb/g1_3h4_6/save/model0.pt',
        # Path to non-exising file, because in this case the model is already loaded in the constructor of the pre-net
    ...
    Configuration(
        ...
        pre_net_mdl_path=P.PROJECT_ROOT + '/results/hebb/g1_4h5_6/save/model0.pt',
        # Path to non-exising file, because in this case the model is already loaded in the constructor of the pre-net
    ...
    Configuration(
        ...
        l2_penalty=5e-2,
        pre_net_class=hebbmodel.g1h2_6.Net,
        pre_net_mdl_path=P.PROJECT_ROOT + '/results/hebb/g1h2_6/save/model0.pt',
        # Path to non-exising file, because in this case the model is already loaded in the constructor of the pre-net
